INSERT INTO "timesheet"."programs" (program_name, start_date, end_date, working_hours) VALUES ( 'Internship ABAP 2020', '2020-03-01', '2020-05-30', 6),
       ( 'Summer School 2019', '2019-07-15', '2019-08-30', 6),
       ( 'Java Training Spring 2020', ' 2020-03-15', '2020-05-30', 6);

INSERT INTO timesheet.users ( first_name, last_name, username, password, role, program_id) VALUES
...
INSERT INTO "timesheet"."psp" (name, program_id) VALUES( 'PSP Self Study',1),
       ('PSP Meeting', 1),
       ( 'PSP Development', 1),
       ( 'PSP Self Study',2),
       ( 'PSP Meeting', 2),
       ...
       ( 'PSP Meeting', 3),
       ( 'PSP Development', 3);
INSERT INTO "timesheet"."booking" (day, user_id) VALUES ('2020-05-30',1),
       ('2020-05-30', 2),
       ('2020-05-30', 3),
       ('2020-05-30', 4),
       ('2020-05-30', 5),
